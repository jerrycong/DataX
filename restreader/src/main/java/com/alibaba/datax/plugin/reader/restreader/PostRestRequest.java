 ...
 * @Version 1.0
 */
public class PostRestRequest extends BaseRestRequest {
    private static final Logger LOG = LoggerFactory.getLogger(PostRestRequest.class);

    public PostRestRequest(Configuration configuration) {
